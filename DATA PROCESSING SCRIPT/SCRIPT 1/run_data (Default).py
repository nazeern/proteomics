"""
This is a copy of `mida/default_data.py`.
...
amino_acid_data = {
   ...
   # Tyrosine (Photo-Decomposition)
    "y": AminoAcid("y", np.array([10, 9, 2, 4, 0], dtype=composition_dtype),
                   labiles=np.array([(0, 0.42)], dtype=labile_dtype)),
   # Methionine (Met-ANL)
    "m": AminoAcid("m", np.array([12, 6, 5, 2, 0], dtype=composition_dtype),
                   labiles=np.array([(0, 1.12)], dtype=labile_dtype)),			   
   # Methionine (Met-CY3-ANL)
    "m": AminoAcid("m", np.array([17, 9, 5, 2, 0], dtype=composition_dtype),
                   labiles=np.array([(0, 1.12)], dtype=labile_dtype)),					   
}
...
enriched_aa_abundances = None
enriched_aa_fractions = None
